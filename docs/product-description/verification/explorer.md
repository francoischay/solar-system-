...
| --- | --- | --- | --- | --- | --- | --- | --- |
| PANN-01 | P1 | simulateur | Le bouton Explorer ouvre le panneau, toujours sur l'onglet Sondes ([levé sans mouvement](../explorer/panneau.md#levé-sans-mouvement)). | Vue d'ensemble. | 1. Toucher le bouton ◎ à gauche du dock.<br>2. Fermer à la croix, passer sur Lancements ? Non : fermer, rouvrir. | Ouverture sur Sondes les deux fois, même si le panneau a été fermé depuis un autre onglet. | — |
| PANN-02 | P1 | simulateur | L'onglet Satellites sélectionne la Terre et rapproche la caméra ([levé sans mouvement](../explorer/panneau.md#levé-sans-mouvement)). | Panneau ouvert, aucune sélection. | 1. Toucher l'onglet Satellites. | Cartouche « Terre », rapprochement net (plus près que pour une planète touchée). | — |
| PANN-03 | P2 | simulateur | Le glyphe du bouton Explorer suit l'onglet : ◎ fermé, ✦ Sondes, ▣ Satellites, ↑ Lancements ([le cas simple](../explorer/panneau.md#le-cas-simple)). | — | 1. Passer par les trois onglets, puis fermer. | Le glyphe change à chaque onglet et revient à ◎ fermé. | — |
...
| SOND-08 | P3 | simulateur | La grille des sondes est triée par année de départ ([les 26 sondes](../explorer/sondes.md#les-26-sondes)). | Panneau > Sondes. | 1. Lire l'ordre des lignes. | Voyager 2 et 1 en tête (1977), les plus récentes à la fin. | — |
...
| SATL-03 | P1 | simulateur | La méta d'un engin pas encore lancé devient « lancé en {année} » et l'engin disparaît de la scène ([la méta d'une ligne](../explorer/satellites.md#la-méta-dune-ligne)). | Onglet Satellites, bascule allumée, pas « Année ». | 1. Amener la date en 1990.<br>2. Lire la ligne « ISS » et chercher la station. | Méta « lancé en 1998 », aucune maquette ISS dans la scène ; Hubble (1990) selon sa date exacte. | — |
...
| SATL-05 | P2 | simulateur | La note du panneau suit l'état des données ([la note du bas de panneau](../explorer/satellites.md#la-note-du-bas-de-panneau)). | Onglet Satellites, réseau actif, puis date poussée à +3 mois. | 1. Lire la note à l'ouverture.<br>2. Pousser la date hors fenêtre, relire. | « Propagation SGP4 · TLE du {date} », puis « Positions indicatives · loin du TLE du {date} ». | — |
