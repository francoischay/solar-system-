...
| TOUCH-02 | P1 | simulateur | Un tap dans le vide désélectionne tout et rend la vue d'ensemble ([levé sans mouvement](../selection/toucher-un-astre.md#levé-sans-mouvement)). | Une lune sélectionnée, roulis incliné. | 1. Toucher le fond étoilé. | Désélection, lunes cachées, recul à la vue d'ensemble, horizon remis à plat. | — |
...
| TOUCH-08 | P3 | simulateur | Un tap dans le vide sans sélection ne fait rien du tout ([cas limites](../selection/toucher-un-astre.md#cas-limites)). | Vue d'ensemble, horizon incliné à la torsion au préalable ? Non : vue d'ensemble propre. | 1. Taper le fond étoilé plusieurs fois. | Aucun mouvement, aucun changement. | — |
